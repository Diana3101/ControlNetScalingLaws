...
accelerate launch train_laion_controlnet_webdataset.py \
 ...
 --output_dir="/mnt/disk_60tb/checkpoints_laion/laion500k-depth" \
 --dataloader_num_workers=12 \
 --mixed_precision="bf16" \
 --resolution=512 \
 --condition_type='depth' \
 --validation_set_folder='validation_set_laion_depth' \
...
#   --resume_from_checkpoint="/mnt/disk_60tb/checkpoints_laion/laion500k-depth/checkpoint-1000" \
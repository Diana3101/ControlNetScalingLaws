...
# The file is an adaptation of the https://github.com/huggingface/diffusers/blob/main/examples/controlnet/train_controlnet.py
...
def main(args):
    ...
    if args.lr_scheduler == 'one_cycle_pytorch':
        lr_scheduler = get_onecycle_schedule(optimizer=optimizer, 
